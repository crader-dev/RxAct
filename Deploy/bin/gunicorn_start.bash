...
DJANGO_SETTINGS_MODULE=rxact-core.settings        # which settings file should Django use
DJANGO_WSGI_MODULE=rxact-core.wsgi                # WSGI module name
...
exec /webapps/RxAct/env/bin/gunicorn ${DJANGO_WSGI_MODULE}:application \
  --name $NAME \
  --workers $NUM_WORKERS \
